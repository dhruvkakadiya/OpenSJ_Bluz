...
class I2C_Base
{
    public:
        ...
        /// Initializes I2C Slave at the given address
        bool initSlave(uint8_t slaveAddr, uint8_t* buffer, uint8_t len);
    ...
    private:
        ...
        uint8_t i2c2_addr;
        uint8_t *i2c2_reg_base;
        bool flag_addr_read;
        uint8_t i2c2_reg_index;
        uint8_t i2c2_reg_len;
