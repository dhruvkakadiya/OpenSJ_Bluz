...
CMD_HANDLER_FUNC(LETaskHandler)
{
    if(cmdParams == "on 1")
        LE.on(1);
    else if(cmdParams == "on 2")
        LE.on(2);
    else if(cmdParams == "on 3")
        LE.on(3);
    else if(cmdParams == "on 4")
        LE.on(4);
    else if(cmdParams == "off 1")
        LE.off(1);
    else if(cmdParams == "off 2")
        LE.off(2);
    else if(cmdParams == "off 3")
        LE.off(3);
    else if(cmdParams == "off 4")
        LE.off(4);
    else if(cmdParams == "on all")
        LE.setAll(15);
    else if(cmdParams == "off all")
        LE.setAll(0);
    return true;
}
